...
function getAnchor(id: string): HTMLAnchorElement | null {
...
let portalRefreshTimer: number | null = null;
...
async function openNotasPopup(): Promise<void> {
...
function renderPortalContent(content: SiteContent | null | undefined): void {
...
function refreshPortalContentIfNeeded(force = false): void {
...
function startPortalRefreshLoop(): void {
