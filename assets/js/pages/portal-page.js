    ...
    if (quickLinksList) {
      quickLinksList.innerHTML = quickLinks.length
        ? quickLinks
            ...
            .join("")
        : '<div class="text-sm text-gray-500 italic">Nenhum link cadastrado.</div>';
    }
  } catch (error) {
    console.warn("Falha ao carregar conteúdo estruturado.", error);
    if(noticeList) noticeList.innerHTML = '<div class="text-sm text-gray-500 p-4 font-mono">Erro ao carregar avisos.</div>';
  }
}
